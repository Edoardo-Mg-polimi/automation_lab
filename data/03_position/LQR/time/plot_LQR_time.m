...
files = {
    fullfile(scriptDir, 'LQR_lastlesson_1.mat')
    fullfile(scriptDir, 'LQR_lastlesson_2.mat')
    fullfile(scriptDir, 'LQR_lastlesson_3.mat')
    fullfile(scriptDir, 'LQR_lastlesson_4.mat')
    fullfile(scriptDir, 'LQR_lastlesson_5.mat')
    fullfile(scriptDir, 'LQR_lastlesson_6.mat')
};
