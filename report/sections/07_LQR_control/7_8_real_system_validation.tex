...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{../img/LQRI_validation/time/LQ_TimeValid_PositionTracking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{../img/LQRI_validation/time/LQ_TimeValid_PositionError.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{../img/LQRI_validation/time/LQ_TimeValid_CurrentTracking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{../img/LQRI_validation/time/LQ_TimeValid_SpeedEstimation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../img/LQRI_validation/frequency/LQR_1_rad.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../img/LQRI_validation/frequency/LQR_6_rad.png}
